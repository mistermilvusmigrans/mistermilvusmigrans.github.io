...
## Explanation
_Lifted from_ ["Integrating the value of the process with the goal" from _Integrating the Actual and the Potential_ from **Philosophy in Practice** from **Philosophy**](https://mistermilvusmigrans.github.io/philosophy/philosophy-in-practice/2-integrating-actual-and-potential.html#integrating-the-value-of-the-process-with-the-goal).
