...
If one’s morality is the practical framework to pursue one’s value for one’s life in the broadest context available, then one’s pursuit of life is defined by one’s pursuit of happiness and not one’s avoidance of suffering. For more on the pursuit of happiness, see: [_The Pursuit of Happiness_ from **Philosophy in Practice**](https://mistermilvusmigrans.github.io/philosophy-v1/philosophy-in-practice/foundations/6-pursuit-of-happiness.html).
