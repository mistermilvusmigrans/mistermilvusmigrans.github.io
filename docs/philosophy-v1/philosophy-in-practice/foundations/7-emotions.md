...
This is discussed further here: [_Sources of Inefficacy_](https://mistermilvusmigrans.github.io/philosophy/philosophy-in-practice/foundations/3-sources-of-inefficacy.html). To summarise for reference, the emotions of despair and shame arise due to an invalid view of one's basic efficacy in dealing with reality.

## Superiority / inferiority complex
**_An invalid view of standards_**

The following section is mostly taken from ["Superiority and inferiority" from _Judgement in Practice_](https://mistermilvusmigrans.github.io/philosophy/philosophy-in-practice/foundations/4-judgement-in-practice.html#superiority-and-inferiority).
